...
func Test_kDB_HSet(t *testing.T) {
...
func Test_kDB_HSetNx(t *testing.T) {
	db := ReopenDb()
	defer db.Close()
...
func Test_kDB_HGet(t *testing.T) {
	db := ReopenDb()
	defer db.Close()
...
func Test_kDB_HGetAll(t *testing.T) {
	db := ReopenDb()
	defer db.Close()
...
func Test_kDB_HDel(t *testing.T) {
	db := ReopenDb()
	defer db.Close()
...
func Test_kDB_HExists(t *testing.T) {
	db := ReopenDb()
	defer db.Close()
...
func Test_kDB_HKeys(t *testing.T) {
	db := ReopenDb()
	defer db.Close()
...
func Test_kDB_HValues(t *testing.T) {
	db := ReopenDb()
	defer db.Close()
...
func Test_kDB_HLen(t *testing.T) {
	db := ReopenDb()
	defer db.Close()
